...
SELECT CongTy.TenCongTy, COUNT(DuAn.MaDuAn) AS SoDuAn 
FROM CongTy 
...
SELECT KyNang.TenKyNang, COUNT(ChuyenGia_KyNang.MaChuyenGia) AS SoChuyenGia 
FROM KyNang 
...
SELECT TenCongTy, AVG(SoNhanVien) OVER () AS TrungBinhNhanVien 
FROM CongTy 
